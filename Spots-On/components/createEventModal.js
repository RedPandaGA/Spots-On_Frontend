...
import { Modal, Dimensions, StyleSheet, View, Text, Image, Animated, PanResponder, TouchableOpacity, TouchableWithoutFeedback, TextInput, Keyboard, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
import Bar from './bar';
...
const CreateEventModal = ({ isModalVisible, hideModal, setSocialModal }) => {
    ...
    const onChange = (e, selectedDate) => {
        ...
        let minutes = tempDate.getMinutes() > 9 ? tempDate.getMinutes() : '0' + tempDate.getMinutes();
        if (hours == 0 || hours == 12) {
            hours = 12;
        } else if (hours > 12) {
            hours -= 12;
