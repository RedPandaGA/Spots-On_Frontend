...
import { StyleSheet, Animated, Text, View, TouchableOpacity, TouchableWithoutFeedback, Keyboard, Image, KeyboardAvoidingView, Button, PanResponder } from "react-native";
                    ...
                    {spots.map((spot) => (
                        <View key={spot.id}>
                            ...
                            >
                                ...
                                <Callout style={styles.callout}>
                                    ...
                                    <View style={styles.calloutImageContainer}>
                                        <CalloutSubview onPress={() => console.log("Clicked edit spot")}>
                                            <Image source={require('../assets/pencil.png')} style={styles.editImage} />
                                        </CalloutSubview>
                                        <CalloutSubview onPress={() => console.log("Clicked description/spot info")}>
                                            <Image source={require('../assets/info.png')} style={styles.infoImage} />
                                        </CalloutSubview>
                                    </View>
                            ...
                            <Circle 
                                ...
                                fillColor={spot.safe ? 'rgba(44, 103, 101, .3)' : 'rgba(255, 85, 85, .3)'}
                            />
                        </View>
                    ))}
                    <Circle 
